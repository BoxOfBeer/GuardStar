...
def upgrade() -> None:
    ...
    with op.batch_alter_table("planets") as batch:
        batch.add_column(sa.Column("population", sa.Integer(), nullable=False, server_default="800"))
        batch.add_column(sa.Column("max_population", sa.Integer(), nullable=False, server_default="5000"))
        batch.add_column(sa.Column("planet_class", sa.String(length=32), nullable=False, server_default="earthlike"))
        batch.add_column(sa.Column("build_slots_total", sa.Integer(), nullable=False, server_default="55"))

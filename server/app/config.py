...
class Config:
    def __init__(self) -> None:
        ...
        self.AUTO_TICK_ENABLED = os.environ.get("AUTO_TICK_ENABLED", "false").lower() in ("1", "true", "yes", "on")
        self.AUTO_TICK_INTERVAL_SECONDS = float(os.environ.get("AUTO_TICK_INTERVAL_SECONDS", "5"))
